...
const EspecificacionesExpandibles = () => {
          ...
          <div className="w-full">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              {[
                ...
                { label: 'Procesador específico txt', value: 'Mediatek Dimensity 7300x' },
                { label: 'Resistente al agua', value: 'IP68 (Protegido contra inmersión)' },
          ...
          <div className="w-full">
            ...
            <div className="mt-6 text-sm text-gray-700 space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-5">
                  <li>
                    La memoria interna y la RAM disponibles para el usuario dependen del sistema operativo y las aplicaciones precargadas.
                  </li>
                </ul>
              </div>
...
export default EspecificacionesExpandibles;
